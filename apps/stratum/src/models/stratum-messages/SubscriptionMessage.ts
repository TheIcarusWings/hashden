...
export class SubscriptionMessage extends StratumBaseMessage {
    ...
    public response(clientId: string, extranonce2Size: number) {
        return {
            id: this.id,
            error: null,
            result: [
                ...
                extranonce2Size //Extranonce2_size - Expected length (bytes) of extranonce2 the miner generates. Configurable via EXTRANONCE2_SIZE; MUST match the coinbase region reserved in MiningJob.
            ]
        }
