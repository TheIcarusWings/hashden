 # Solo Mining Pool Marketplace — Project Brief

A standalone project brief. Drop this file into the new project's repo (e.g. as `PROJECT.md` or alongside `README.md`). It assumes no prior context other than what is written here.

---

## 1. Vision

A **marketplace of solo-mining groups** on Bitcoin, with Nostr-native identity, discovery, and payouts.
